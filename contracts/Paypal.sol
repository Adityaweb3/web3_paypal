...
contract Paypal {
    ...
    // Requiements : 1. Define Owner Of Smart Contract 
    // 2. Create struct , mapping for requests , transactions and name 
   // 3. Add a name to wallet address 
   // 4. Create A Request 
   // 5 . Pay a Request 
   // 6. Get all request sent to a user 
   // 7. Get all the history of transaction user has been part of 
